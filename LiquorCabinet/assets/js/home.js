        ...
        reader.onload = function (e) {
            ...
            $.ajax({
                ...
                success: function (json) {
                    localStorage.setItem("resp",JSON.stringify(json));
                    $('#title'+ idnum).html(json.name);
                    console.log("i am working \n");
                    console.log("Full response: ", json);
                    console.log("\n Mac is: ", json[1].Mac);
                    console.log("\n Laptop is: ", json[1].Laptop);
                    console.log("\n No Laptop is: ", json[1].no_Laptop);
                    console.log("most recomended ", json[0]);

                    location.replace("http://127.0.0.1:8000/recommendations/");
